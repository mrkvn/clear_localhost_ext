...
- Check `.claude/rules/` for project-specific rules and conventions
...
**Filename**: `docs/feature_plans/{NNN}-{kebab-case-descriptive-name}.md`

- `{NNN}` is a zero-padded 3-digit sequence number, incrementing from the highest existing plan number in `docs/feature_plans/`
- If no plans exist, start at `000`. If the highest is `000`, the next is `001`, then `002`, etc.
- Replace `{kebab-case-descriptive-name}` with short, descriptive feature name
- Examples: `000-add-user-authentication.md`, `001-implement-search-api.md`, `002-refactor-database-layer.md`

**Directory**: `docs/feature_plans/` (create if it doesn't exist)

**Sequence Detection**: Before writing, list existing files in `docs/feature_plans/` to determine the next sequence number.
